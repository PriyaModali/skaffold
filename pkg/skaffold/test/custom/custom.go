...
func (tr *Runner) Test(ctx context.Context, out io.Writer) error {
	color.Default.Fprintln(out, "Priya: Custom Test()...")
	if msg, err := tr.runCustomCommand(ctx, out, tr.customTest); msg == "" {
