...
func (tr *Runner) runCustomScriptCmd(ctx context.Context, out io.Writer, t latest.CustomTest) error {
	cmd, err := tr.retrieveCmdCmd(ctx, out, t)
	if err != nil {
...
func (tr *Runner) retrieveCmdCmd(ctx context.Context, out io.Writer, t latest.CustomTest) (*exec.Cmd, error) {
